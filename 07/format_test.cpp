...
int formatTest() {
    ...
    format_tester.execute("1 interesting 3.1 test four", false, "{0} interesting {2} test {3}", 1, "two", 3.1, "four");
    format_tester.execute("1 very 1 interesting 3.1 test four", false, "{0} very {1} interesting {2} test {3}", 1, true, 3.1, "four");
    format_tester.execute("", true, "{0}}", "abc");
    format_tester.execute("", true, "{{0}", "abc");
    format_tester.execute("", true, "{{0}}", "abc");
    format_tester.execute("", true, "{01}", "abc");
